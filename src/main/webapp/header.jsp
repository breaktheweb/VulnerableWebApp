		...
		<ul id="menu-bar" style="margin-left: auto ;  margin-right: auto ;" >
			...
			<!-- <li><a href="#">Possible Vulnerability</a> -->
				<ul>
							...
							<li><a href="#">V1 - SQL Injection</a>
								<ul>
								  <li><a href="<%=path%>/vulnerability/forumposts.jsp?postid=1">SQL Injection</a></li>
								  <li><a href="<%=path%>/login.jsp">Authentication Bypass</a></li>
								  <li><a href="<%=path%>/vulnerability/sqli/download.jsp">Blind SQL Injection</a></li>
	                              <li><a href="<%=path%>/vulnerability/sqli/union2.jsp">Union 2</a></li>
		                        </ul>
		                    </li>                     
	                        <li><a href="#">V2 - XPath Injection</a>
	                             <ul>
